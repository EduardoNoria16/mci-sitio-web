    ...
    >
      ...
      <div className="relative flex flex-row w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-inner border border-white/10 group-hover:shadow-2xl transition-shadow duration-500">
        ...
        <div className="relative w-1/2 h-full overflow-hidden">
          <img src={pair.before} alt="Antes" className="w-full h-full object-cover transition-transform duration-[2000ms] ease-out group-hover:scale-110 group-hover:rotate-1" draggable={false} referrerPolicy="no-referrer" loading="lazy" decoding="async" />
        ...
        {/* Mitad Después */}
        <div className="relative w-1/2 h-full overflow-hidden">
          <img src={pair.after} alt="Después" className="w-full h-full object-cover transition-transform duration-[2000ms] ease-out group-hover:scale-110 group-hover:-rotate-1" draggable={false} referrerPolicy="no-referrer" loading="lazy" decoding="async" />
            ...
            >
              ...
              >
                ...
                <div className="w-full md:w-1/2 relative h-[35vh] md:h-[65vh] group pt-16 md:pt-0">
                  <img src={selectedPair.before} alt="Antes" className="w-full h-full object-contain bg-black/80" referrerPolicy="no-referrer" loading="lazy" decoding="async" />
                ...
                <div className="w-full md:w-1/2 relative h-[35vh] md:h-[65vh] group">
                  <img src={selectedPair.after} alt="Después" className="w-full h-full object-contain bg-black/80" referrerPolicy="no-referrer" loading="lazy" decoding="async" />
