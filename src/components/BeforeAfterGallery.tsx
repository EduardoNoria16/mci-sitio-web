    ...
    >
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {/* CONTENT & DETAILS */}
          <div className="absolute inset-x-0 bottom-0 z-30 p-6 sm:p-10 flex flex-col md:flex-row items-end md:items-center justify-between gap-6 pointer-events-none">
