...
const targetSection = content.substring(
  ...
  content.indexOf('{/* Thank you and image */}')
);

const newSection = `{/* Contact Section explicitly inside Part 2 */}
      <section id="contacto" className="relative z-10 max-w-5xl mx-auto px-5 md:px-6 py-20 md:py-32">
        <div className="text-center mb-10 md:mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white uppercase tracking-tighter drop-shadow-sm mb-4">
            ¿TIENES UN <span className="text-brand-orange">PROYECTO EN MENTE?</span>
          </h2>
          <div className="w-24 md:w-32 h-1.5 md:h-2 bg-brand-orange mx-auto rounded-full shadow-[0_0_20px_rgba(245,130,32,0.3)] mb-8" />
          <p className="text-slate-300 max-w-2xl mx-auto text-lg md:text-xl font-medium tracking-tight">
            Permítenos mostrarte por qué somos la mejor opción.<br className="hidden md:block"/> Esperamos contar pronto con una oportunidad para servirte.
          </p>
        </div>
